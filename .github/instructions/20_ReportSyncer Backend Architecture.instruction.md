...
**Author:** ReportSyncer Architecture Team
...
3. **Plan:** `IDependencyResolver` builds the execution order (DAG sort).
    ...
    - _Delete Order:_ Children -> Parents.
        
    - _Insert Order:_ Parents -> Children.
...
| `interface` | **`IDependencyResolver`**         | Contract to build execution order.                                                                                                                                       |
