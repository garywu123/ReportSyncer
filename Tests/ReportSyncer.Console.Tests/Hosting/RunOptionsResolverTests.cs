...
public sealed class RunOptionsResolverTests
{
    ...
    public void Resolve_CliOverridesAppsettings_ForConfigPath()
    {
        ...
        var appSettings = new HostAppSettings(new HostRunSettings("app.yaml", true), null, null, null);
    ...
    public void Resolve_DefaultsWhenNeitherProvided()
    {
        // Arrange
        var cli = new CliRunOptions(null, null);
        var appSettings = new HostAppSettings(new HostRunSettings(null, null), null, null, null);
    ...
    public void Resolve_CliDryRunOverridesAppsettings()
    {
        ...
        var appSettings = new HostAppSettings(new HostRunSettings(null, true), null, null, null);
    ...
    public void Resolve_NullAppsettingsRun_UsesDefaults()
    {
        // Arrange
        var cli = new CliRunOptions(null, null);
        var appSettings = new HostAppSettings(null, null, null, null);
    ...
    public void Resolve_CliConfigOnly_AppsettingsDryRun()
    {
        ...
        var appSettings = new HostAppSettings(new HostRunSettings("app.yaml", false), null, null, null);
    ...
    public void Resolve_WhitespaceCliConfig_TreatedAsNotProvided()
    {
        ...
        var appSettings = new HostAppSettings(new HostRunSettings("app.yaml", null), null, null, null);
